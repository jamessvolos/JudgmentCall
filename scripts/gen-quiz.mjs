...
console.log(`wrote prisma/quiz.ts with ${seeds.length} items (${stats.length} statistics, ${arch.length} architecture, ${economics.length} economics mcq, ${market.length} market)`);
