...
export const DRILL_COMPOSE: DrillSeed[] = [
    ...
    slots: [
      ...
      },
      {
        ...
        options: [
          ...
          { text: "as paid-social spend rose 35%", strength: 2, overreach: false, rationale: "Strongest safe link: it names the co-movement without asserting that it caused the lift." },
      ...
      },
      {
        ...
        options: [
          ...
          { text: "proving paid social is now the growth engine", strength: 3, overreach: true, rationale: "'Proving' on an observational co-movement with no experiment is overreach." },
        ],
      },
    ],
  },
  {
    ...
    explanation:
      "The boldest phrasing is not always the overreach: 'rose from 87% to 93% at the two pilot depots' is the fullest figure AND correctly scoped, so it beats the meek version. The trap is scope, not size. 'Across the network' and 'roll it out to all 40 now' stretch two self-selected volunteer depots to 40 as if the selection effect the readout names outright would travel. The safe lede is bold about the result and honest about the two depots.",
    ...
    slots: [
      ...
      },
      {
        ...
        options: [
          ...
          { text: "over six weeks at two self-selected volunteer sites", strength: 2, overreach: false, rationale: "Strongest safe caveat: it names the selection effect the readout states." },
  ...
  },
  {
    ...
    explanation:
      "The honest lede reports an interim, dated, and unfinished. 'Winner', 'the effect is real', and 'ship B today' all convert a day-9 peek at p=0.06 into a settled verdict, a test spoken past before its own finish line. Note that the strongest safe status is the boldest option in its slot: naming both the p-value and the planned end is the most information the data lets you state.",
    ...
    slots: [
      {
        ...
        options: [
          ...
          { text: "B is the winner at +0.5 points", strength: 3, overreach: true, rationale: "'Winner' on day 9 of 14 at p=0.06 is a peek read as a verdict." },
        ],
      },
      {
        label: "THE STATUS",
        options: [
          { text: "so far", strength: 1, overreach: false, rationale: "Vague. It states neither the p-value nor the horizon." },
          { text: "though the test hasn't reached significance or its planned end", strength: 3, overreach: false, rationale: "Strongest safe status: it names both the p=0.06 and the unfinished run." },
      ...
      },
      {
        ...
        options: [
          ...
          { text: "so hold the call until day 14", strength: 2, overreach: false, rationale: "Strongest safe call: it respects the pre-registered horizon." },
    ...
    slots: [
      ...
      },
      {
        ...
        options: [
          ...
          { text: "while missing 29% of urgent tickets (recall 71%)", strength: 3, overreach: false, rationale: "Strongest safe limit: it names the recall the headline hides." },
      ...
      },
      {
        label: "THE FRAME",
        options: [
          { text: "at launch", strength: 1, overreach: false, rationale: "A throwaway. It frames nothing." },
    ...
    slots: [
      {
        ...
        options: [
          ...
          { text: "Activation fell to 48%, down 13 points from April", strength: 3, overreach: false, rationale: "Strongest safe lead: it opens on the number that actually moved." },
      ...
      },
      {
        ...
        options: [
          ...
          { text: "while CSAT and time-to-first-login stayed flat", strength: 2, overreach: false, rationale: "Strongest safe context: the flats that localize the break to activation rather than support or login." },
      ...
      },
      {
        ...
        options: [
          ...
          { text: "so the activation step is where to investigate first", strength: 2, overreach: false, rationale: "Strongest safe landing: it points the reader at the localized break." },
  ...
  },
  {
    ...
    slots: [
      ...
      },
      {
        label: "THE LOCALIZE",
        options: [
          { text: "on some devices", strength: 1, overreach: false, rationale: "Vague. It drops the one thing that scopes the fix." },
      ...
      },
      {
        label: "THE SO-WHAT",
        options: [
          { text: "and we're monitoring it", strength: 1, overreach: false, rationale: "Describes and decides nothing; the readout exists to trigger a call." },
          { text: "so pause the Android rollout until the chipset crash is patched", strength: 3, overreach: false, rationale: "Strongest safe so-what: it names the reversible action the data points to." },
