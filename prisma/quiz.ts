...
export const QUIZ_SEEDS: QuizSeed[] = [
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "51.2% — the three 80% chances multiply: 0.8 × 0.8 × 0.8.",
        "correct": true,
        "rationale": "Independent probabilities multiply: 0.8³ = 0.512. Each added stage compounds the chance of a miss."
      },
      {
        "text": "80% — each stage is 80%, so the loop is 80%.",
        "correct": false,
        "rationale": "That's the averaging reflex. The loop only succeeds if every stage does, and three 80% hurdles stack to 51.2%."
      },
      {
        "text": "40% — start at 100% and subtract 20% for each stage.",
        "correct": false,
        "rationale": "Failure chances don't add. Subtracting 20% three times overcounts the ways to fail; multiplying gives 51.2%."
      },
      {
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "27.1% — one minus the chance all three are fast: 1 − 0.9³ = 1 − 0.729.",
        "correct": true,
        "rationale": "'At least one' is the complement trick: compute P(none fail) = 0.9³ = 0.729, then subtract from 1."
      },
      {
      ...
      },
      {
        ...
        "correct": false,
        "rationale": "Adding double-counts requests where two or three services miss together. The exact answer is 1 − 0.729 = 27.1%."
      },
      {
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "About 8.3% — of every 1,000 shipments, 9 flags are true fraud and 99 are false alarms, so a flag is fraud 9 times in 108.",
        "correct": true,
        "rationale": "Run the counts: 10 fraudulent → 9 flagged; 990 legitimate → 99 flagged. P(fraud | flag) = 9 / (9 + 99) = 9/108 = 1/12."
      },
      {
        "text": "90% — the detector catches 90% of fraud, so a flag is 90% reliable.",
        "correct": false,
        "rationale": "That inverts the conditional. 90% is P(flag | fraud); the question asks P(fraud | flag), and the 990 legitimate shipments feed the flag pool 99 false alarms."
      },
      {
        "text": "80% — 90% detection minus the 10% false-alarm rate.",
        "correct": false,
        "rationale": "Subtracting the two rates has no probabilistic meaning. The base rate is what matters: false alarms outnumber true hits 99 to 9."
      },
      {
  ...
  },
  {
    ...
    "kind": "mcq",
    "difficulty": 1,
    "scenario": "A product manager pitches a feature that costs $8,000 to build. She estimates a 20% chance it unlocks $50,000 in new revenue, and an 80% chance it moves nothing.",
    "prompt": "What is the expected value of building it?",
    "choices": [
      {
        "text": "+$2,000 — a 20% shot at $50,000 is worth $10,000, minus the $8,000 build cost.",
        "correct": true,
        "rationale": "EV is the probability-weighted payoff net of cost: 0.2 × $50,000 − $8,000 = +$2,000."
      },
      {
      ...
      },
      {
        ...
        "correct": false,
        "rationale": "That's the expected revenue, but the $8,000 build cost is paid in every branch. Net EV is +$2,000."
      },
      {
        "text": "Negative — it fails four times out of five, so it's a losing bet.",
        "correct": false,
        "rationale": "Frequency of failure isn't EV. A bet that usually loses can still be worth taking when the win is big enough: $10,000 expected against $8,000 spent."
      }
    ],
    "payload": null,
    "explanation": "A decision's worth is the probability-weighted sum of its outcomes minus what you pay to play: 0.2 × 50,000 − 8,000 = +$2,000. Neither the best case nor the most likely case is the value of the bet."
  },
  {
    "track": "decision",
    "title": "dec-ev-02",
    ...
    "kind": "mcq",
    "difficulty": 2,
    "scenario": "You're suing a former partner. They've offered a $60,000 settlement. Going to trial costs $20,000 in fees win or lose, and a win pays $200,000 while a loss pays nothing.",
    "prompt": "Above what win probability does trial beat the settlement?",
    "choices": [
      {
        "text": "40% — trial EV is p × $200,000 − $20,000, which passes $60,000 when p exceeds 40%.",
        "correct": true,
        "rationale": "Set the two options equal: p × 200,000 − 20,000 = 60,000 gives p = 80,000 / 200,000 = 40%. That break-even is the price of the bet."
      },
      {
        "text": "30% — the settlement divided by the award: 60,000 / 200,000.",
        "correct": false,
        "rationale": "That ignores the $20,000 in fees you pay either way at trial. The fees raise the bar to (60,000 + 20,000) / 200,000 = 40%."
      },
      {
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "No — A's EV was 0.6 × $700k − 0.4 × $300k = +$300,000, double B's sure $150,000, and the company could easily absorb the loss. The outcome doesn't rewrite the decision.",
        "correct": true,
        "rationale": "Judge the decision by the information and odds at the time. A 40%-likely loss landing is exactly what a good 60/40 bet does four times in ten."
      },
      {
        "text": "Yes — it lost $300,000, and results are what count.",
        "correct": false,
        "rationale": "That's results-oriented hindsight. Grading choices by single outcomes teaches you to refuse every good bet that happens to lose."
      },
      {
  ...
  },
  {
    ...
    "choices": [
      ...
      },
      {
        ...
        "correct": false,
        "rationale": "3x is the average over past spend. Averages flatter saturated channels; the marginal return in A has already fallen to 1.5x."
      },
      {
  ...
  },
  {
    ...
    "kind": "mcq",
    "difficulty": 2,
    "scenario": "Your startup has sunk $400,000 into feature X. Finishing it needs $100,000 more and would generate $150,000 in value. Redirecting that same $100,000 to a pivot would generate $220,000.",
    "prompt": "What should you do with the $100,000?",
    "choices": [
      {
        "text": "Pivot — from here, $100,000 buys $220,000 one way and $150,000 the other. The $400,000 is spent in both futures.",
        "correct": true,
        "rationale": "Only the forward-looking margin differs between your options: +$120,000 net versus +$50,000. Sunk spend cancels out of the comparison."
      },
      {
        "text": "Finish X — abandoning it now would waste the $400,000 already invested.",
        "correct": false,
        "rationale": "That's sunk-cost anchoring. The $400,000 is unrecoverable under every option; honoring it costs you the $70,000 the pivot wins by."
      },
      {
      ...
      },
      {
        ...
        "correct": false,
        "rationale": "Holding returns $0 against forward gains of $50,000 or $120,000. Caution here is the worst-EV branch on the tree."
      }
    ],
    "payload": null,
  ...
  },
  {
    ...
    "kind": "mcq",
    "difficulty": 3,
    "scenario": "Capacity forces your agency to drop one of two clients. The flagship account bills $500,000 a year, consumes $440,000 in direct delivery cost, and requires two dedicated support engineers costing $80,000 who exist only for that account. The small account bills $120,000 against $70,000 of cost. The room wants to keep the flagship.",
    "prompt": "Purely on the numbers, which client should you keep?",
    "choices": [
      {
  ...
  },
  {
    ...
    "kind": "mcq",
    "difficulty": 1,
    "scenario": "Heads-up at the river, the pot is $100 and your opponent bets $50. You hold a bluff-catcher: you win if and only if he's bluffing.",
    "prompt": "What fraction of the time must he be bluffing for your call to break even?",
    "choices": [
      {
        "text": "25% — you risk $50 to win the $150 out there, so you need 50 / (100 + 50 + 50) of the final pot.",
        "correct": true,
        "rationale": "Pot-odds break-even is bet / (pot + bet + your call): 50/200 = 25%. Win a quarter of the time and the call is free."
      },
      {
        "text": "33.3% — your $50 against the $150 in the middle.",
        "correct": false,
        "rationale": "That forgets your own call goes into the pot you're winning back. The final pot is $200, so the bar is 50/200 = 25%."
      },
      {
        "text": "50% — a call has to be right more often than wrong.",
        "correct": false,
        "rationale": "The even-money reflex ignores the price. You're paid 3-to-1, so being right just over one time in four is enough."
      },
      {
    ...
    "payload": null,
    "explanation": "The pot sets the price of a call: break-even equity = bet / (pot + bet + call) = 50/200 = 25%. Before asking whether he's bluffing, know the number the bluffing frequency has to beat."
  },
  {
    "track": "decision",
    "title": "dec-gto-02",
    ...
    "choices": [
      {
        "text": "Two-thirds of the time — a hollow claim earns f × $100k − (1 − f) × $50k if you cave with frequency f, which hits zero at f = 1/3.",
        "correct": true,
        "rationale": "This is the minimum-defense-frequency structure: defend at least pot/(pot + bet) = 100/150 = 2/3, capping their bluff EV at zero."
      },
      {
      ...
      },
      {
        ...
        "correct": false,
        "rationale": "50/50 sounds balanced but still pays them: 0.5 × 100k − 0.5 × 50k = +$25,000 per hollow claim. The threshold comes from their payoffs, not from symmetry."
      },
      {
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "One-third — she calls $100 to win $300, so she needs to win 1 time in 3, and bluffing exactly 1/3 of your pushes gives her exactly that.",
        "correct": true,
        "rationale": "Balanced bluffing share is bet/(pot + 2 × bet) = 100/300 = 1/3: two value pushes for every bluff, making her call EV precisely zero."
      },
      {
        "text": "Half — balanced means half real, half bluff.",
        "correct": false,
        "rationale": "At 50% bluffs her call wins half the time while needing only a third: EV = 0.5 × 200 − 0.5 × 100 = +$50 per call. 'Balanced' means priced to the pot, not split down the middle."
      },
      {
        "text": "Two-thirds — bluff twice for every real push to apply maximum pressure.",
        "correct": false,
        "rationale": "That inverts the ratio. Winning 2/3 of calls when she needs 1/3, she snap-calls everything and prints money: 2/3 × 200 − 1/3 × 100 = +$100 per call."
      },
      {
        "text": "Zero — only push with the winning card, so pushing can never lose.",
        "correct": false,
        "rationale": "The never-bluff strategy is transparent: she correctly folds every time, your value pushes win only the pot and never her $100, and you've left the whole extra street on the table."
      }
    ],
    "payload": null,
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "A minority slice — say $10,000. The edge pays at any size, but only a survivable size lets you keep playing.",
        "correct": true,
        "rationale": "EV per dollar is +$0.20 whether you bet $10k or $50k; what changes with size is the 40% branch, which at full stake ends the company."
      },
      {
        "text": "All $50,000 — the bet is +EV, so more money in means more EV out.",
        "correct": false,
        "rationale": "All-in-because-+EV ignores ruin: four times in ten you're dead and can never take another edge. Expectation math assumes you survive to keep collecting it."
      },
      {
  ...
  },
  {
    ...
    "kind": "mcq",
    "difficulty": 2,
    "scenario": "Your sports model genuinely wins 60% of its picks at even money, and you're staking a $10,000 bankroll one bet at a time, reinvesting as you go.",
    "prompt": "What fraction of the bankroll per bet maximizes long-run growth?",
    "choices": [
      {
        "text": "20% — for even money the growth-optimal (Kelly) fraction is win probability minus loss probability: 0.6 − 0.4.",
        "correct": true,
        "rationale": "Kelly for even-money bets is p − q = 20%. Below it you grow slower than you could; above it extra variance eats the extra edge."
      },
      {
      ...
      },
      {
        ...
        "correct": false,
        "rationale": "Growth peaks at Kelly and falls past it: at double-Kelly, long-run growth collapses back to roughly zero while the swings double. More stake stops meaning more growth."
      }
    ],
    "payload": null,
  ...
  },
  {
    ...
    "kind": "mcq",
    "difficulty": 3,
    "scenario": "Your firm holds $1M in cash against a $300,000 monthly payroll. A client offers a fixed-fee contract: 80% chance it nets you $500,000, but a 20% chance of a penalty scenario that costs you $900,000. The EV is 0.8 × $500k − 0.2 × $900k = +$220,000, and your CFO wants to sign as-is.",
    "prompt": "What's the right call on the contract as offered?",
    "choices": [
      {
      ...
      },
      {
        ...
        "correct": false,
        "rationale": "EV averages over futures, including the one where the company dies before the average arrives. All-in-because-+EV is exactly how winners go broke."
      },
      {
      ...
      },
      {
        ...
        "correct": false,
        "rationale": "Right instinct, wrong math: weighted by probability it's +$220,000, comfortably a winning bet. The problem is its size relative to your cash, which is why shrinking or laying off risk beats walking away."
      }
    ],
    "payload": null,
  ...
  {
    "track": "decision",
    "title": "dec-exploit-01",
    "topic": "exploitation",
    "kind": "mcq",
    "difficulty": 1,
    "scenario": "Scouting an opposing keeper before a penalty shootout, your analyst finds he has dived to his left on all eight recorded penalties this season.",
    "prompt": "Where should your kickers aim?",
    "choices": [
      {
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "Bluff far more often than equilibrium — and track his calls, because a leak this profitable gets noticed once you start hammering it.",
        "correct": true,
        "rationale": "An 80% fold rate against a 33.3% cap makes over-bluffing hugely +EV, but the deviation is visible. The exploit lasts exactly as long as the read does."
      },
      {
      ...
      },
      {
        ...
        "correct": false,
        "rationale": "The number is a snapshot. Every deviation opens a door back at you: once he starts calling, each unmonitored bluff burns $50, and 'always' has no tripwire for noticing."
      },
      {
  ...
  {
    "track": "decision",
    "title": "dec-exploit-03",
    "topic": "exploitation",
    "kind": "mcq",
    "difficulty": 3,
    "scenario": "Your insurer faces a category of $150,000 injury claims. Fighting one in court costs $50,000 in legal fees: against a fraudulent claim you win and pay nothing, against a genuine one you pay the $150,000 anyway, plus the fees. Audits show only 10% of claims in this category are fraudulent. The claims chief's policy is to fight, on principle: 'settling teaches fraudsters we're soft.'",
    "prompt": "On the numbers, what's the right policy for this category?",
    "choices": [
      {
        "text": "Settle them — fighting only breaks even when at least a third are fraudulent, and at 10% each fight costs 0.1 × $100k saved − 0.9 × $50k burned = −$35,000 on average.",
        "correct": true,
        "rationale": "Versus settling, fighting saves $100,000 against fraud but wastes $50,000 against genuine claims: break-even fraud rate is 50/150 = 1/3, and 10% is nowhere close."
      },
      {
        "text": "Fight every claim — never reward fraud, whatever each case costs.",
        "correct": false,
        "rationale": "Principle at −$35,000 per claim is a $35,000 donation, 90% of it spent fighting honest customers. Deterrence has a price, and this one is above its value."
      },
      {
        "text": "Fight them — winning saves $100,000 and only costs $50,000, so fighting pays 2-to-1.",
        "correct": false,
        "rationale": "That's the best case read as the expected case. The 2-to-1 payoff lands just 10% of the time; the other 90% you pay the claim and the fees."
      },
      {
  ...
  },
  {
    ...
    "kind": "gap",
    "difficulty": 2,
    "scenario": "Launch review. Ship now: 70% it lands clean (+$50k), 25% it lands soft (+$20k), 5% a bad outage (−$120k). Harden first: 90% a clean but later launch (+$40k), 10% you miss the window (+$10k). Every probability and payoff is on the table.",
    "prompt": "Set the margin: which line wins, and by how much per launch?",
    "choices": [],
    "payload": {
      "lineA": {
        "name": "Ship now",
  ...
  },
  {
    ...
    "kind": "gap",
    "difficulty": 1,
    "scenario": "Two offers on the desk. Startup: 60% the equity vests as hoped ($180k all-in), 40% it doesn't ($90k). BigCo: 95% the standard package pays $150k, 5% a re-org trims it to $120k.",
    "prompt": "Set the margin: which offer wins, and by how much in year-one value?",
    "choices": [],
    "payload": {
      "lineA": {
        "name": "The startup offer",
        "branches": [
          {
            "p": 0.6,
            "v": 180
  ...
  {
    "track": "decision",
    "title": "gap-warranty-01",
    "topic": "expected_value",
    "kind": "gap",
    "difficulty": 2,
    "scenario": "A $55 two-year warranty on a device with an 8% failure rate. Out of warranty, a failure costs $400 to replace. Under warranty, a failure still costs a $50 deductible on top of the $55 you paid.",
    "prompt": "Set the margin: which choice wins, and by how much per gadget?",
    "choices": [],
    "payload": {
      "lineA": {
        "name": "Decline the warranty",
        "branches": [
          {
            "p": 0.92,
            "v": 0
  ...
  },
  {
    ...
    "kind": "gap",
    "difficulty": 3,
    "scenario": "Two data vendors. A costs more but degrades gracefully: 90% a smooth year (+$50k of value), 10% a rough patch you absorb (+$40k). B is cheaper on the sticker: 90% a smooth year (+$45k), 10% an unrecoverable data loss (−$80k).",
    "prompt": "Set the margin: which vendor wins, and by how much per year?",
    "choices": [],
    "payload": {
      "lineA": {
        "name": "Vendor A, with backups",
        "branches": [
          {
            "p": 0.9,
            "v": 50
  ...
  },
  {
    ...
    "kind": "gap",
    "difficulty": 3,
    "scenario": "Nine months of runway. All-in on landing the big client: 60% you land it (+$300k), 40% you don't and the company nearly dies (−$200k). Half-commit: 60% you land a smaller version (+$190k), 40% you lose little (−$40k). The board has argued about this for three weeks.",
    "prompt": "Set the margin: which plan wins, and by how much in expected value?",
    "choices": [],
    "payload": {
      "lineA": {
        "name": "Bet the runway on the big client",
        "branches": [
          {
            "p": 0.6,
            "v": 300
      ...
      "lineB": {
        "name": "Half commit, keep optionality",
        "branches": [
          {
            "p": 0.6,
            "v": 190
  ...
  },
  {
    ...
    "kind": "gap",
    "difficulty": 1,
    "scenario": "At checkout: a guaranteed $25 rebate, or one entry in a drawing — 2% chance at $1,000, otherwise nothing.",
    "prompt": "Set the margin: which option wins, and by how much per entry?",
    "choices": [],
    "payload": {
      "lineA": {
        "name": "Take the sure rebate",
        "branches": [
          {
            "p": 1,
            "v": 25
  ...
  },
  {
    ...
    "kind": "gap",
    "difficulty": 2,
    "scenario": "One headcount, two finalists. The star: 70% they stay and transform the team (+$120k of impact), 30% they leave in six months and the backfill costs you (−$60k). The steady senior: 95% solid delivery (+$70k), 5% a quiet miss (−$10k).",
    "prompt": "Set the margin: which hire wins, and by how much in first-year impact?",
    "choices": [],
    "payload": {
      "lineA": {
        "name": "The star with flight risk",
        "branches": [
          {
            "p": 0.7,
            "v": 120
