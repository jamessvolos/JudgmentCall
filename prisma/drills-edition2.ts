...
export const EDITION2: DrillSeed[] = [
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    explanation:
      "Three programs launched at the pilot schools the same fall (the curriculum, the fourteen tutors, the attendance push), so the seven points belong to that bundle until something separates them; the superintendent's draft hands the whole gain to one member of it. It also spends the seven points as if every point were program: non-pilot schools rose three with none of the interventions, and the re-normed test lifted every district about two, so the baseline itself was moving under the pilot's feet. The faithful telling keeps all the numbers, holds the bundle together, and leaves the curriculum's share where the dossier leaves it: unassigned.",
    faithfulText:
    ...
    choices: [
      {
        ...
        correct: false,
        rationale:
          "Over the line. One year-over-year change (part of it the re-norm's two points) is a single interval, and a single interval has no slope. Nothing in the dossier says the second year resembles the first.",
      },
      {
      ...
      },
      {
        ...
        correct: false,
        rationale:
          "Over the line in reverse. The re-norm lifted all districts about two points, so it can't account for the pilot's rise past its own district's non-pilot baseline. Writing the programs off entirely is as much an overclaim as crediting the curriculum alone; over-correction is still mis-assignment.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        correct: false,
        rationale:
          "HOLDS. The denominator's own movement, read straight. It is also the fact the verdict row needed and ignored.",
      },
      {
      ...
      },
      {
        ...
        correct: true,
        rationale:
          "EXCEEDS. The 62% is real arithmetic (340 / 210), but sales grew 75% and the per-unit rate fell. The count-only read points the opposite direction from the rate, and 'slipping' hangs a quality verdict on the dropped denominator.",
      },
    ],
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        correct: false,
        rationale:
          "HOLDS. The tempting flag, since it says 'drives', but the 'if' is doing real work: a conditional that leaves the causal question open is not a causal claim, and the session's zero price is on the page. Flagging honest hypotheticals would ban thinking out loud.",
      },
      {
      ...
      },
      {
        ...
        correct: false,
        rationale:
          "HOLDS. A caveat is a claim too, and this one is grounded: the memo states there was no assignment. A hedge that fits the data is discipline rather than overreach.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        correct: false,
        rationale:
          "Leads correctly, then asserts a cause the data doesn't establish: 96% completion says the training was taken, not that it failed or why finance clicked. It also escalates to an unsized suspension of payment authority; fixing the order doesn't license new claims.",
      },
      {
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        correct: true,
        rationale:
          "Just right. It names the decision the data supports (fix and test the measured choke point) and keeps the expected payoff honest with the self-selection caveat.",
      },
      {
  ...
  },
  {
    ...
    difficulty: 3,
    contextSnippet:
      "**Silverthorn Insurance, embedded-checkout channel, first 4 months:** acquisition cost **$18/policy** vs **$54** blended across other channels · **2,900** policies sold · loss ratio to date **31%** vs **58%** book average, though the embedded policies are **0–4 months old**, and claims on this line typically **emerge over 18–24 months** · current volume runs through **one retail partner**.",
