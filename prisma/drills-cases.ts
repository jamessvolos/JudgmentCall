...
export const CASE_SEEDS: DrillSeed[] = [
  ...
  },
  {
    ...
    explanation:
      "The trap sits between two innocent rows. Claim 2 is the tempting flag, since it carries the same 38%, but it is scoped exactly right: it speaks only for the leavers who answered. Claim 3 takes the identical number and swaps the denominator: 38% of the 31% who responded puts roughly 12% of all departing customers on record citing price, and nothing in the dossier says the silent 69% leave for the same reasons as the vocal minority. Claims 1 and 4 are straight reads of the page. One number serves two claims, and the denominator is the entire difference between them.",
    ...
    choices: [
      ...
      },
      {
        ...
        correct: false,
        rationale:
          "HOLDS. Scoped exactly right: 'who answered' pins the 38% to the responders it came from. A survey share reported inside its own denominator is the discipline this ledger is checking for.",
      },
      {
        text: "Roughly two in five departing customers are leaving over price.",
        correct: true,
        rationale:
          "EXCEEDS. Only 31% of leavers answered, so the 38% describes responders rather than departures: about 12% of all leavers are actually on record citing price. 'Two in five departing customers' assumes the silent 69% answer like the vocal 31%, which is precisely what a low-response survey cannot show.",
      },
      {
  ...
  },
  {
    ...
    explanation:
      "The lede is the judgment call. This dossier's real story is the price increase's first scorecard: retention held above 100% while churn rose half a point. The draft parks that behind an 11-quarter streak that would have been true with or without the increase. The repair is ordering plus completeness: open on the retention-and-churn scorecard, keep both numbers, and let the streak ride as context. Note the failure modes on either side of the correct rewrite: leading with the streak buries the rise, leading with the alarm buries the hold, and a well-made summary refuses both directions of burial.",
    ...
    choices: [
      ...
      },
      {
        ...
        correct: false,
        rationale:
          "The mirror image of the original flaw: it leads with the alarm and demotes the retention hold, the one number in the dossier still reading net-positive, to a parenthetical. This lede buries the good news the way the draft buried the bad.",
      },
      {
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        correct: true,
        rationale:
          "Just right. Carries the dossier's Q2 reading forward as a conditional and names the one thing a single quarter cannot yet show: stabilization.",
      },
      {
        text: "Churn returns to 2.4% in Q3 now that the competitor's discount campaign has ended.",
        correct: false,
        rationale:
          "Over the line. The campaign is an unruled-out alternative rather than an established cause; the dossier never separates its effect from the price increase's, so its end predicts nothing about where churn settles.",
      },
      {
        text: "Pricing power is proven — Q2 shows Northgate can take a further increase in Q3 without losing ground.",
        correct: false,
        rationale:
          "Over the line twice. It settles the first increase's verdict on one quarter, then stacks a second projection on top. Churn already rose half a point, so 'without losing ground' contradicts the ground on the page.",
      },
    ],
  },
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        correct: false,
        rationale:
          "HOLDS. A conditional rather than a forecast: 'if it holds' leaves the load-bearing question open, and the consequence it claims is only what a yes would show, with no promise that the yes is coming.",
      },
      {
        text: "We cannot yet separate the model's effect from the schedule change and the new hires.",
        correct: false,
        rationale:
          "HOLDS. The dossier says all three landed the same month; naming the entanglement is a limitation stated as a limitation. A hedge grounded in the readout is discipline, and clearing it is the point.",
      },
    ],
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        correct: false,
        rationale:
          "Over the line. A flag is a warning rather than an averted outage: the dossier never counts a single fault a flag actually headed off, so 61% flagged is not 61% prevented. 'Largely preventable' is an operational result the pilot didn't measure.",
      },
      {
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        correct: false,
        rationale:
          "Buries the recommendation under every hedge available. The pilot earned a next step; the craft task is to carry the one caveat that matters while still making the call, instead of dispersing the call across four.",
      },
      {
