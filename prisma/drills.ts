...
const DRILL_BASE: DrillSeed[] = [
  ...
  },
  {
    ...
    explanation:
      "The context says launch months normally run +10–15%: most of the 18% rise is seasonal baseline, so attributing the full rise to the redesign inflates the effect roughly threefold. The faithful telling subtracts the base rate; the overclaim ignores it and repeats the classic missing-denominator move.",
