...
export const metadata: Metadata = {
  ...
  description:
    "How well-calibrated are you? Answer, stake how sure you are, and see whether your confidence matches your accuracy — across statistics, economics, data architecture, decision science, and data storytelling. ~2 min.",
};
